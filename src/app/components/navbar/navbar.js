...
class HomeComponent extends React.Component {
    ...
    return (
        <div id="outer-container">
            <Menu onStateChange={ this.isMenuOpen.bind(this) } pageWrapId={"page-wrap"} onClick={()=>console.log("On click!")} isOpen={ this.state.isOpen } width={ '50%' } id="scaleRotate" outerContainerId={'outer-container'} >
                <div id="page-wrap">
